...
{ VARIABLES USADAS PARA LOS MENORES }

	opc5:string;

	canti:string;

	canti2,error:integer;
	...
	var_menores:record
			...
			menor_nom,menor_apell,menor_edad:string;
...
begin
	...
	opc5:=''; error:=0; error2:=0;

	///////////////////////////////

	telef2:=0; ced2:=0; dias2:=0;	

	n1:=(telef2+ced2+dias2);

	codi:=0;	n1:=0;	registrado:='';	codigo:=0;



/////////////| SI NO EXISTE EL ARCHIVO ESTE CODIGO LO DETECTA Y CREA UNO PARA PODER USARLO |///////////////////////////////////////////////////////////////////
																											
	if not fileExists('GRUPOS.TXT') then 																
																											
	begin																									
		assign(personas,'GRUPOS.TXT');																	
...
////////////////////////////////////////| INICIO DEL BLOQUE I |//////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	assign(personas,'GRUPOS.TXT'); {...................................................................................................................... AQUI SE INICIALIZA EL ARCHIVO}	
	...
	{1}repeat {.......................................................................................................................... ESTE REPEAT ES PARA QUE SE REPITA SI INGRESA LETRAS}
		 ...
		 {2}repeat {...................................................................................... ESTE ES PARA QUE SE REPITA EN CASO DE QUE DECIDIERA VER LAS ANTIGUAS RESERVACIONES}
			...
			gotoxy(1,1);write(' -Bienvenido, cuantas personas se van a registrar?.            -Puede ver las antiguas reservaciones ingresando cero ');gotoxy(53,1);readln(n);gotoxy(1,1);
...
///////////////////////////| FIN DEL MENÚ DE RESERVACIONES ANTIGUAS |/////////////////////////////////////////////////////////////////////////////////////////////



/////////////////| VALIDAMOS Y SI DA ERROR IMPREME EL AVISO Y REPITE CON EL 1-UNTIL |//////////////////////////////////////////////////////////////////////////////
				...
				if (codi<>0) then
					...
					begin
					clrscr;
					gotoxy(30,3);writeln(' -No se aceptan valores no numericos, intente de nuevo');
					//writeln;
					end;
...
//////////////////////////| SOLICITUD DE DATOS DEL CLIENTE |///////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{3}	repeat {....................................................................................ES REPEAT REINICIA LA SOLCITUD DE DATOS SI LA CEDULA DEL CLIENTE YA ESTABA REGISTRADA}
			...
			begin clrscr; write(' -Ingrese el nombre del siguiente cliente: ');readln(nom); end
...
/////////////////////////////////////////////////////////////////////| INICIO DEL REGISTRO DE MENORES |////////////////////////////////////////////////////////////////////////////////////////

				
				while (opc5<>'s') and (opc5<>'n') do

		begin

			clrscr;
			write(' -Lleva menores de edad con usted? (s) (n) '); opc5:=readkey;
	...
	begin
		...
		if not fileExists('MENORES.TXT') then
		
		
		begin
		
			assign(menores,'MENORES.TXT'); 
		...
		assign(menores,'MENORES.TXT');
			...
			repeat
				...
				clrscr;
				write(' -Indiquenos la cantidad: '); readln(canti);
				
				val(canti,canti2,error);
				
			until (error=0) and (canti2>0);
				
			
		
		for ind:=1 to canti2 do
		...
		begin
			...
			begin
			clrscr;
			write(' -Ingrese el nombre del siguiente menor: '); readln(menor_nom);
			end
				else
					begin
					clrscr;
					write(' -Indiquenos el nombre del menor: '); readln(menor_nom);
					end;
				
				clrscr;
				write(' -Ahora su apellido: '); readln(menor_apell);
				...
				write(' -Ingrese su edad: ');readln(menor_edad);
				
				val(menor_edad,menor_edad2,error2);
				
				until (error2=0) and (menor_edad2<18);
								
			
		menor_datos:=( ' -Nombre del menor: '+menor_nom+' -Apellido: '+menor_apell+' -Edad: '+menor_edad);
		
				
		append(menores);
		
		
		writeln(menores,menor_datos);
		writeln(menores);
		...
		end; {........................................................................................................... END - ESTE ES DEL ' WITH VAR_MENORES ' }
		
		clrscr;
		writeln(' -Agregando menor...');
		writeln;
		delay(2000);
		...
		begin
		writeln(' -Hemos terminados de agregar a los menores');
		delay(1300);
		end
			else
				begin
				writeln(' -Listo, nuevo menor agregado continuemos con el siguiente');
				delay(1300);
				end;
		
			
		end; {.................................................................................................... END - ' ESTE ES DEL FOR IND:=1 TO CANTI2 DO ' }
	...
	{3}	until (opc4='s'); {............................................................................ SI RESULTA QUE LA CEDULA YA ESTABA REGISTRADA SE REPITE, SI NO, NO LO HACE }
			...
			with individuales do {.................................................................................... LLAMAMOS NUEVAMENTE A NUESTRO RECORD PARA USAR SUS VARIABLES }
				...
				if (opc5='s') then
					...
					writeln(personas,' Hijos:');
					writeln(personas);
					
						while not eof(menores) do
						
						begin
						
						readln(menores,linea_god);
						writeln(personas,linea_god);
